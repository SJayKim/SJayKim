...
### 5. 부산관광공사 여행 스케줄링 챗봇 · Search · Service
...
[![MarketScope AI Demo](images/marketscope_light.png)](https://github.com/SJayKim/SJayKim/releases/download/v1.0-demo/marketscope_demo.mp4)

> 이미지를 클릭하면 데모 영상이 재생됩니다.
